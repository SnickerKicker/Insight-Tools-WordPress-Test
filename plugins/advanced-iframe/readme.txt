...
By entering the shortcode '[advanced_iframe]' you can include any web page to any page or article. 
...
[advanced_iframe securitykey=""   src="" 
  ...
  include_html = ""   enable_ios_mobile_scrolling = ""
  sandbox = ""   show_iframe_as_layer_header_file = ""
  show_iframe_as_layer_header_height = ""   show_iframe_as_layer_header_position = ""
  resize_min_height = ""   show_iframe_as_layer_full = ""
  show_part_of_iframe_zoom = ""    show_iframe_as_layer_keep_content = ""
  parent_content_css = ""    include_scripts_in_content = ""
  debug_js = ""   title = ""
  allow = ""    safari_fix_url = ""
  change_iframe_links_href = ""   show_part_of_iframe_media_query = ""
  src_hide = ""   use_iframe_title_for_parent = ""
  fullscreen_button = ""
  ]
...
- Fix: Resize on element resize and lazy load could lead to an error as a variable was not reintialized when the iframe code is added to the page. 
