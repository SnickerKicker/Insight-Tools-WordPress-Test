...
class CVP_LIVE_FILTER_OUTPUT {
	...
	function radio() {
		$this->items = array( '' => !empty( $this->others[ 'default_text' ] ) ? stripslashes( $this->others[ 'default_text' ] ) : __( 'All', 'content-views-pro' ) ) + $this->items;
	...
	function dropdown() {
		$default		 = !empty( $this->others[ 'default_text' ] ) ? stripslashes( $this->others[ 'default_text' ] ) : (($this->data_type === CVP_LF_SORT) ? __( 'Default', 'content-views-pro' ) : __( 'All', 'content-views-pro' ));
