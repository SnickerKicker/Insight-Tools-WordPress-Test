									...
									array(
										...
										'params' => array(
											array(
												...
												'std'		 => '',
												'desc'	 => __( 'Please do NOT enable this option when you separate filters and results using ', 'content-views-pro' ) . '<code>[pt_view id="VIEW_ID" show="filter"]</code>, <code>[pt_view id="VIEW_ID" show="result"]</code>',
											),
										),
									),
									array(
