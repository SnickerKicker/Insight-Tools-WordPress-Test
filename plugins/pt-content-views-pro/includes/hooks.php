                            ...
                            switch ( $field ) {
                                case 'thumbnail':
                                    ...
                                    if ( $term_img ) {
                                        ...
                                        // Thumbnail style and format
                                        $thumbnail_class   = array();
                                        $thumbnail_class[] = PT_CV_PREFIX . 'thumbnail';
                                        $thumbnail_class[] = PT_CV_Functions::setting_value( PT_CV_PREFIX . 'field-thumbnail-style' );
                                        if ( PT_CV_Functions::setting_value( PT_CV_PREFIX . 'layout-format' ) === '2-col' ) {
                                            $thumbnail_position = PT_CV_Functions::setting_value( PT_CV_PREFIX . 'field-thumbnail-position' );
                                            $thumbnail_class[]  = 'pull-' . $thumbnail_position;
                                        }
                                        $term_img = str_replace( 'class="', 'class="' . esc_attr( implode( ' ', $thumbnail_class ) ) . ' ', $term_img );
